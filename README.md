...
This is a fork of [nospaceships/node-net-ping v1.2.4](https://github.com/nospaceships/node-net-ping) and uses @justjam2013/node-raw-socket, for compatibility with Node 24. This fork was created because "overrides" is broken in npm v11.6.1 and is only for supporting my Homebridge plugin.
